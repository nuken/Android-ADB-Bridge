# Android ADB Bridge v5.1.5 Win-Go
...
1. Double-click the `AndroidBridge_Setup_v5.1.5.exe` file to run the installer.
...
Setting up hundreds of channels manually can be tedious. Version 5.1.3 introduces a dual-import system to let you download entire channel lineups in seconds.
